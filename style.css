...
/* Custom overrides for RVG Properties */
:root {
  --color-primary-custom: #1E90FF;
  --color-secondary-custom: #FF6B6B;
  --color-success-custom: #10B981;
  --color-warning-custom: #F59E0B;
  --color-gradient-1: linear-gradient(135deg, #1E90FF 0%, #00BFFF 100%);
  --color-gradient-2: linear-gradient(135deg, #FF6B6B 0%, #FF8E8E 100%);
  --color-gradient-hero: linear-gradient(135deg, rgba(30, 144, 255, 0.9) 0%, rgba(0, 191, 255, 0.9) 100%);
}
...
.tab-btn.active {
  color: var(--color-primary-custom);
  border-bottom-color: var(--color-primary-custom);
}
...
.btn--warning {
  background: var(--color-warning-custom);
  color: white;
}
...
.spinner {
  ...
  border-top: 4px solid var(--color-primary-custom);
  border-radius: 50%;
